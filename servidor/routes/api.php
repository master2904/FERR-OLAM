...
Route::get('/tipo/imprimir/{id}', [TipoController::class,'imprimir']);
Route::get('/tipo/inventario/{id}', [TipoController::class,'inventario']);
...
Route::get("/relacion/lista/{id}",[RelacionController::class,'lista']);
